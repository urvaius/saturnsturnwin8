...
namespace SaturnsTurn.Utility
{
    ...
    /// </summary>
    public class AudioManagerfix : GameComponent
    {
        #region Fields
        ...
        /// </summary>
        static AudioManagerfix audioManager = null;
        public static AudioManagerfix Instance
        {
        ...
        private AudioManagerfix(Game game)
            : base(game) { }
        ...
        {
            audioManager = new AudioManagerfix(game);
